...
public class BlurGesturesListener implements PointerEventListener {
    private static final String TAG = "BlurGestures";
    ...
    public BlurGesturesListener(Context paramContext, Callbacks callbacks) {
